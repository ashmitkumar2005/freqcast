...
export default function GetStartedPage() {
    return (
        <main className="min-h-[calc(100vh-64px)] bg-black text-white">
            <section className="mx-auto max-w-5xl px-4 py-10 md:py-10">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <Link
                        href="/creator"
                        className="group rounded-2xl border border-zinc-800 p-8 transition transform duration-300 hover:border-zinc-400 hover:bg-zinc-900/40 hover:scale-105 hover:shadow-[0_0_20px_rgba(132,204,22,0.6)]"
                    >
